...
public class Puzzle extends JFrame implements ActionListener {
    ...
    private void createGrid() {
        ...
        for (int i = 0; i < buttons.length; i++) {
            ...
            buttons[i].setBounds(startX + (i % gridSize) * horizontalSpacing, startY + (i / gridSize) * verticalSpacing, BUTTON_WIDTH, BUTTON_HEIGHT);
            ...
            for (int i = 0; i < buttons.length; i++) {
                if (e.getSource() == buttons[i]) {
                    ...
                    if (isSolved()) {
                        ...
                        createGrid();  // Move to the next level (4x4 grid)
                    }
